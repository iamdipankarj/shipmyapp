      ...
      <div className="w-full md:w-1/3 mx-auto">
        <div className="flex flex-col p-4 rounded-lg shadow bg-base-100">
          ...
          <div className="flex mt-4 flex-col md:flex-row gap-4">
            <button onClick={onTryAgain} className="flex-1 btn btn-success text-white btn-sm">Try Again</button>
            <button onClick={onHomeClick} className="flex-1 btn btn-sm">Home</button>
          </div>
        </div>
      </div>
    </main>
